...
// Enterprise register — email/password + Google + GitHub OAuth2
// register() signature kept: authService.register(firstName, lastName, email, password)
...
@Component({
        ...
        <div class="form-fields">
          <div class="field-row">
            <div class="field">
              ...
              <input [(ngModel)]="firstName" placeholder="Sourabh"
                     class="field-input" autocomplete="given-name" />
            </div>
            <div class="field">
              <label>Last Name</label>
              <input [(ngModel)]="lastName" placeholder="Dohare"
          ...
          <div class="field">
            ...
            <div class="pw-wrap">
              <input [type]="showPw() ? 'text' : 'password'"
                     ...
                     class="field-input" (keydown.enter)="register()"
  ...
  styles: [`
    ...
    .hint { font-size:10px; color:#475569; text-transform:none; font-weight:400; letter-spacing:0; }
    .field-input {
...
export class RegisterComponent {
  ...
  // Spring Security handles the OAuth2 dance — frontend just opens this URL
  ...
  register() {
    ...
    // Matches existing AuthService.register(firstName, lastName, email, password) signature
